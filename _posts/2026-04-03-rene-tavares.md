---
layout: post
title:  " 'Luso-Português' - whose desire afterall?"
---
...
In *My place of reflection* a lofty figure looks down on the viewer whilst occupying a chair identical to the one in *The next future* except for the armillary sphere - a symbol of the Portuguese national flag - the omission pointing to a change of power. Key technical feats make this painting remarkable - the gestural brushwork in the background is filled with color and movement, making the central figure pop, focusing our attention at the piercing gaze.

Following this expressiveness, the family portrait opening the exhibition deals with memory and identity: a photo is both a lingering specter of the past and an anchor for the future. Resembling a photo in its layout, this painting points to the theft of agency (due to the lack of movement) and authenticity inherent in performing a pose for a still.

René represents symbols of Portuguese culture: the *Vista Alegre* ceramics with bright blue pigment from cobalt oxide or the naperon embroidery in the curtains, objects which refer to prestige and social status - but not from the original culture being portrayed. They're an oxidation process where the portuguese imaginarium corrodes the substrate, when those historically oppressed use signs of the oppressor to position themselves in a social hierarchy - the title’s irony reinforcing this point.

![3]({{ site.baseurl }}/assets/img/image(2).png)
_Uma família bem portuguesa, 2025. (Translation: “Quite a Portuguese family”) Natural pigment, oil, stencil, charcoal. Photo by Bruno Lopes_

Residing in the background, these symbols contrast with a somewhat flat texture of both the clothes and the skin of the people portrayed. Their faces dull. The foreground subject - possibly an elder - is covered with a fabric which resembles the naperon, her memories lost or covered. 

A tryptic ensues with identical motifs: furniture covered with naperons and ceramics with striking colors - the latter holding cotton flowers inside, a symbol of colonial economies. A consistent language is maintained via the contrast from a dense background in a brown palette and a vivid foreground full of symbols, whilst the figures portrayed retain their intentional gaze. The difference across the three paintings being the family portrait frame - moved from being a small appendage in the memorabilia of a house, to a figure barely protruding through the marks of oppression, and ultimately a stronger presence in the leftmost painting - a story across generations mirrored in the piece’s title.

![4]({{ site.baseurl }}/assets/img/image(3).png)
_O espelho da minha história, 2025. (Translation: “My story’s mirror”) Natural pigment, oil, stencil, charcoal. Photo by Bruno Lopes_
...
![4]({{ site.baseurl }}/assets/img/Las_Meninas,_by_Diego_Velázquez,_from_Prado_in_Google_Earth.jpg)
...
This tension is clear across the exhibition: the nuance, emotional charge, complexity, and depth of the family portrait contrasts the unidimensionality of the chair; much like the tryptic stands in opposition to a series of portraits akin to passport photos with stamps. Here the white fabric and the title’s apostrophes point towards the conditional nature of personhood, which in this case is dependent on masking one’s identity under a white veil.

![5]({{ site.baseurl }}/assets/img/image(4).png)
_“Pessoa” por de trás do véu, 2025. (Translation: “A ‘person’ behind the veil”) Natural pigment, oil, stencil, charcoal. Photo by Bruno Lopes_

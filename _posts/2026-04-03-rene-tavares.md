...
![3]({{ site.baseurl }}/assets/img/image(2).png){: width="350" }
...
![4]({{ site.baseurl }}/assets/img/image(3).png){: width="350" }
...
![4]({{ site.baseurl }}/assets/img/Las_Meninas,_by_Diego_Velázquez,_from_Prado_in_Google_Earth.jpg){: width="350" }
...
![5]({{ site.baseurl }}/assets/img/image(4).png){: width="350" }
